...
using Models.AuthModels.ViewModels.Auth;
using System.Text.Json;

namespace AuthBackend.Controllers.Api
{
...
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        {
            _logger.LogDebug($"User {User.Identity!.Name} Logout");
            return View();
        }
        ...
        {
            _logger.LogDebug($"LogoutPost - User {User.Identity!.Name}");
